...
export function FoodLogItem({ log, onDelete, isDeleting }: { log: FoodLog; onDelete?: (id: string) => void; isDeleting?: boolean }) {
  return (
    <div className="flex items-center justify-between rounded-xl border border-gray-100 bg-white px-4 py-3 shadow-[0_1px_3px_rgba(0,0,0,0.06)]">
      <div className="flex-1 min-w-0 mr-3">
        ...
        <div className="flex gap-3 mt-1 flex-wrap">
          ...
          <Macro value={Math.round(log.protein_g)} unit="P" color="text-blue-600" />
