    ...
    <Dialog open onOpenChange={onClose}>
      <DialogContent className="max-h-[90vh] overflow-y-auto">
        ...
        <div className="space-y-4">
          {/* Quick-pick grid */}
          <div>
            <Label className="text-xs font-semibold uppercase tracking-wide text-muted">Pick activity</Label>
                ...
                <button
                  ...
                  className={`flex flex-col items-center gap-1 rounded-2xl border py-2 px-1 text-xs font-semibold transition-all active:scale-95 ${
                    selectedActivity === a.label
                      ...
                      : 'border-gray-100 bg-gray-50 text-gray-600 hover:border-orange-200 hover:bg-orange-50 dark:border-slate-700 dark:bg-slate-800 dark:text-slate-300 dark:hover:border-orange-800 dark:hover:bg-orange-950/20'
                  }`}
                >
          ...
          {/* Or type custom */}
          <div>
            <Label htmlFor="activity" className="text-xs font-semibold uppercase tracking-wide text-muted">
              Or type custom
            </Label>
            <Input
              id="activity"
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              <Label htmlFor="duration" className="text-xs font-semibold uppercase tracking-wide text-muted">
                Duration (min)
              </Label>
              <Input
                id="duration"
            ...
            <div>
              <Label htmlFor="calories" className="text-xs font-semibold uppercase tracking-wide text-muted">
                Kcal burned
          ...
          {selectedActivity && (
            <div className="rounded-2xl border border-emerald-100 dark:border-emerald-900/30 bg-emerald-50 dark:bg-emerald-950/20 px-4 py-2 text-xs text-emerald-700 dark:text-emerald-400">
