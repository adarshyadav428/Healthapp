...
function getBmiCategory(bmi: number): BmiCategory {
  if (bmi < 18.5) return { label: 'Underweight', emoji: '⚠️', color: 'text-blue-700', darkColor: '', bg: 'bg-blue-50', darkBg: '', border: 'border-blue-100', darkBorder: '', bar: 'bg-blue-400' }
  if (bmi < 25)   return { label: 'Healthy', emoji: '✅', color: 'text-emerald-700', darkColor: '', bg: 'bg-emerald-50', darkBg: '', border: 'border-emerald-100', darkBorder: '', bar: 'bg-emerald-500' }
  if (bmi < 30)   return { label: 'Overweight', emoji: '⚠️', color: 'text-amber-700', darkColor: '', bg: 'bg-amber-50', darkBg: '', border: 'border-amber-100', darkBorder: '', bar: 'bg-amber-500' }
  return           { label: 'Obese', emoji: '🔴', color: 'text-rose-700', darkColor: '', bg: 'bg-rose-50', darkBg: '', border: 'border-rose-100', darkBorder: '', bar: 'bg-rose-500' }
}
