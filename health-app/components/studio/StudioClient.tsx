...
const WORLDS: Record<Direction, Record<string, string>> = {
  onyx: {
    ...
    '--s-ambient':
      'radial-gradient(120% 36% at 50% -8%, rgba(110,155,255,.07), transparent 62%)',
    '--s-card-shadow': '0 1px 0 rgba(255,255,255,.04) inset, 0 12px 32px -16px rgba(0,0,0,.5)',
    '--s-float-shadow': '0 1px 0 rgba(255,255,255,.05) inset, 0 24px 60px -24px rgba(0,0,0,.75)',
    '--s-cta-shadow': '0 6px 18px -6px rgba(255,92,31,.35)',
    '--s-fab-shadow': '0 8px 20px -6px rgba(255,92,31,.40)',
    '--s-track': 'rgba(242,243,245,.08)',
    '--s-arc-glow': '.55',
    '--s-ring-drop': 'drop-shadow(0 0 18px rgba(255,110,60,.25))',
    '--s-glass': 'rgba(24,26,31,.72)',
    '--s-glass-hair': 'rgba(242,243,245,.08)',
    '--s-p': '#6E9BFF',
    '--s-c': '#FFB454',
    '--s-f': '#FF7A6E',
    '--s-pill': 'rgba(242,243,245,.05)',
    '--s-dim': 'rgba(0,0,0,.55)',
    '--s-cta-grad': 'linear-gradient(180deg, #FF8A55 0%, #F8601F 100%)',
    '--s-ava-grad': 'linear-gradient(150deg, #FF9F6E, #F5551A)',
    '--s-ava-halo': 'rgba(255,122,69,.25)',
    '--s-hero-wash': 'linear-gradient(180deg, rgba(110,155,255,.05), transparent 42%)',
    '--s-bloom': 'none',
  },
  porcelain: {
    '--s-canvas': '#F4F5F7',
    ...
    '--s-ambient':
      'radial-gradient(120% 36% at 50% -8%, rgba(74,125,224,.07), transparent 62%)',
    '--s-card-shadow':
      '0 1px 2px rgba(21,23,28,.04), 0 8px 24px -12px rgba(21,23,28,.08)',
    '--s-float-shadow':
      '0 2px 6px rgba(21,23,28,.05), 0 20px 48px -16px rgba(21,23,28,.16)',
    '--s-cta-shadow': '0 6px 16px -6px rgba(241,102,46,.30)',
    '--s-fab-shadow': '0 8px 20px -6px rgba(241,102,46,.35)',
    '--s-track': '#E8EAEE',
    '--s-arc-glow': '.22',
    '--s-ring-drop': 'drop-shadow(0 8px 16px rgba(241,102,46,.18))',
    '--s-glass': 'rgba(255,255,255,.78)',
    '--s-glass-hair': 'rgba(21,23,28,.06)',
    '--s-p': '#4A7DE0',
    '--s-c': '#E0961F',
    '--s-f': '#E05A4E',
    '--s-pill': 'rgba(21,23,28,.04)',
    '--s-dim': 'rgba(21,23,28,.56)',
    '--s-cta-grad': 'linear-gradient(180deg, #F8743E 0%, #EC5F25 100%)',
    '--s-ava-grad': 'linear-gradient(150deg, #FF9560, #E8551C)',
    '--s-ava-halo': 'rgba(241,102,46,.22)',
    '--s-hero-wash': 'linear-gradient(180deg, rgba(74,125,224,.05) 0%, rgba(255,255,255,0) 52%)',
    '--s-bloom': 'radial-gradient(closest-side, rgba(241,102,46,.12), transparent 72%)',
  },
}
