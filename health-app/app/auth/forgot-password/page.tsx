  ...
  return (
    <div className="min-h-screen bg-canvas flex flex-col items-center justify-center px-4">
      <div className="w-full max-w-sm">
        <Link href="/auth/sign-in" className="inline-flex items-center gap-1 text-body text-ink-2 hover:text-ink mb-6 transition-colors">
        ...
        <h1 className="font-display text-title font-bold text-ink mb-1">Forgot password?</h1>
        <p className="text-body text-ink-2 mb-7">Enter your email and we&apos;ll send a reset link.</p>
        ...
        {sent ? (
          <div className="text-center py-8">
            ...
            <p className="text-body-lg font-bold text-ink">Check your inbox!</p>
            <p className="text-body text-ink-2 mt-2">
              We sent a password reset link to <strong>{email}</strong>.
            </p>
            <p className="text-caption text-ink-2 mt-1">It may take a minute. Check spam if you don&apos;t see it.</p>
