...
export default function NotFound() {
  return (
    <div className="min-h-screen bg-canvas flex flex-col items-center justify-center px-6 text-center">
      ...
      <h1 className="font-display text-5xl font-bold text-ink mb-2">404</h1>
      <p className="text-lg font-bold text-ink mb-1">Page not found</p>
      <p className="text-sm text-ink-2 mb-8 max-w-xs">
      ...
      <div className="flex flex-col gap-3 w-full max-w-xs">
        <Link
          href="/dashboard"
          className="w-full rounded-control bg-brand py-3 text-sm font-bold text-white text-center hover:opacity-90 active:scale-[.98] transition-all shadow-rest"
        >
          Go to Dashboard
        </Link>
        <Link
