    ...
    <div className="min-h-screen bg-canvas pb-24">
      ...
      <main className="relative mx-auto flex w-full max-w-md flex-col gap-6 px-4 py-6">
        ...
        <div className="space-y-1.5">
          ...
          <div className="h-7 w-16 rounded-full bg-surface-2 animate-shimmer" />
          <div className="h-3 w-32 rounded bg-surface-2 animate-shimmer" />
        </div>
            ...
            <div className="flex-1 space-y-3">
              {[1, 2, 3].map((i) => (
                <div key={i} className="space-y-1">
                  <div className="h-3 w-16 rounded bg-surface-2 animate-shimmer" />
        ...
        <div className="mx-auto flex h-16 max-w-md items-center justify-around px-2">
          {[1, 2, 3, 4, 5].map((i) => (
            <div key={i} className="flex flex-col items-center gap-1">
              <div className="h-6 w-6 rounded bg-surface-2 animate-shimmer" />
              <div className="h-2 w-8 rounded bg-surface-2 animate-shimmer" />
            </div>
          ))}
        </div>
      </div>
