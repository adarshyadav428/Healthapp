    ...
    <div className="min-h-screen bg-background pb-24 dark:bg-slate-950">
      ...
      <main className="mx-auto w-full max-w-md px-4 py-6 space-y-6">
        ...
        <div className="flex gap-2">
          {[1, 2, 3].map((i) => (
            <div key={i} className="h-8 flex-1 rounded-xl bg-gray-200 animate-shimmer dark:bg-slate-700" />
          ))}
        </div>
        ...
        {/* Chart */}
        <div className="rounded-3xl bg-white p-4 shadow-sm border border-gray-100 dark:border-slate-800 dark:bg-slate-900">
          <div className="h-4 w-32 rounded bg-gray-200 animate-shimmer mb-4 dark:bg-slate-700" />
          <div className="h-48 w-full rounded-xl bg-gray-100 animate-shimmer dark:bg-slate-800" />
        </div>
        ...
        <div className="space-y-2">
          {[1, 2, 3, 4].map((i) => (
            <div key={i} className="h-16 w-full rounded-2xl bg-white shadow-sm border border-gray-100 animate-shimmer dark:border-slate-800 dark:bg-slate-900" />
          ))}
        </div>
      </main>
    </div>
