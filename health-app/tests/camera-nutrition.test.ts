...
import { resolveNutrition, num, type GeminiFood } from '../lib/camera-nutrition'
...
describe('resolveNutrition()', () => {
  ...
  it('returns null for pcs items missing totals', () => {
    expect(resolveNutrition({ ...base, unit: 'pcs' })).toBeNull()
  })
})
