      ...
      <div className="mx-auto w-full max-w-2xl">
        ...
        <div className="space-y-6 rounded-3xl border border-orange-100 bg-white/90 p-6 shadow-sm">
          ...
          <Section title="5. Data and Privacy">
            ...
            personal data. See our <Link href="/privacy" className="text-orange-600 hover:underline">Privacy
          ...
          <Section title="9. Contact">
            ...
            <a href="mailto:support@caltrack.app" className="text-orange-600 hover:underline">
